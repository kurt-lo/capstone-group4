...
//
//    private final ContainerDTO container = new Container(1L, "Dry", "Ace Hardware", "MNL", "Singapore");
//
//    @Test
//    public void testCreateContainer() throws Exception {
//        when(containerService.createContainer(any(Container.class))).thenReturn(container);
//
//        mockMvc.perform(post("/api/containers/create")
...
//
//    @Test
//    public void testDeleteNotExistingContainer() throws Exception {
//        when(containerService.deleteContainer(3L)).thenReturn(false);
//
//        mockMvc.perform(delete("/api/containers/3")).andExpect(status().isNotFound());
//
...
//        when(containerService.updateContainer(1L, updatedData)).thenReturn(updatedData);
//
//        mockMvc.perform(put("/api/containers/1")
//                        .contentType(MediaType.APPLICATION_JSON)
