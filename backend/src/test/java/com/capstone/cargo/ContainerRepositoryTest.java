...
public class ContainerRepositoryTest {
    ...
    public void testGetContainerByOwner() {
        containerRepository.save(new Container(null, "RFR", "Ace Hardware", "MNL", "HKG"));
        containerRepository.save(new Container(null, "FRF", "SM", "MNL", "HKG"));
        containerRepository.save(new Container(null, "ZRF", "Potato Corner", "MNL", "HKG"));
    ...
    @Test
    public void testGetNotExistingContainerByOwner() {
        containerRepository.save(new Container(null, "RFR", "Ace Hardware", "MNL", "HKG"));
        containerRepository.save(new Container(null, "FRF", "SM", "MNL", "HKG"));
        containerRepository.save(new Container(null, "ZRF", "Potato Corner", "MNL", "HKG"));

        Optional<Container> findOwner = containerRepository.findByOwner("OOCL");

        assertThat(findOwner).isNotPresent();
    }
    ...
    public void testDeleteNotExistingContainer() {
        ...
        Optional<Container> findId = containerRepository.findById(2L);

        assertThat(findId).isNotPresent();
    }
